...
- [Message Edit and Retry UX](message_edit_retry_ux.md) — Inline latest-root-turn editing with attachment restoration, steer exclusion, navigation cancellation, replay warnings, and preserved original history.
...
- [Sanad Client Interface](client_interface.md) — Current devices, workspaces, conversations, user attachments, View Image media, providers, permissions, and responsive interaction behavior.
