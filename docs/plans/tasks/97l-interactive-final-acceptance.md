...
- [ ] الوكيل يستقبل أوامر أثناء أداة بطيئة؛ لا حلقة checkpoint ولا empty flash ولا دوران مستمر للمؤشرات المستهدفة.
- [ ] التقرير النهائي والقبول على المنصات المتأثرة مكتملان أو بوابة التسليم blocked بوضوح؛ لا commit/push دون إذن المستخدم.
