...
- [ ] مؤشر واحد وعدة أدوات وجلسات نشطة لا تنشئ ticker مستمرًا في المؤشرات المستهدفة على Windows.
- [ ] الفرق بين idle والنشاط الثابت ضمن ميزانية 97a وCPU/GPU أقل من baseline الحركي؛ حالات التنفيذ وaccessibility صحيحة.
