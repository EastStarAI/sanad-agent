...
- **البوابة الحالية:** G8 — PR #120 اجتاز CI والمراجعات المحمية وينتظر قرار الدمج.
- **نسبة العمل المتبقي:** 5% لقرار الدمج ثم بوابة الإصدار G9 المستقلة.
...
- [x] نجح `All required checks pass` مع Agent/Client وكل bootstrap platforms
  والمراجعتين `security-reviewed` و`release-reviewed` بتفويض المالك.
- [x] لم يحدث merge تلقائي أو تنظيف worktree؛ ينتظر PR قرار المالك المستقل.
