...
- [ ] امتلاك المشكلة مباشرة بعد حذف المهمة 96 غير الدقيقة: تحويل اللوج الخام إلى fixture منقح وإعادة إنتاج حتمية، ثم إثبات أو رفض فرضية أن نتائج checkpoint المتراكمة والمفهرسة بـ`toolCall.id` وحده تُعاد عبر model steps جديدة عند تكرار IDs.
