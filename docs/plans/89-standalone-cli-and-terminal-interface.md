...
| **89l** | **تقوية ثبات اختبارات CLI غير المتزامنة** | `completed` | Done | 2 | **مكتملة:** استبدلت sleeps السباقية في REPL وLocal Gateway بانتظار أحداث WebSocket الحتمية، وثبتت بالضغط وPublic CI دون rerun. |
