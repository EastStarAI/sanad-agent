...
status: "in_progress"
current_gate: "89j — G5 live verification and closure; 89k planned follow-up"
remaining_estimate: "6% of 89j; 89k tracked separately"
priority: "high"
...
| **89j** | **إكمال Standalone وتقوية عقود الأتمتة والإصدار** | `in_progress` | G5 | 18 | **على التوالي (Sequential):** يغلق فجوات R0، وملكية الحالة، ونقاء JSON، والمهلة/الإلغاء، واختبارات Process/AOT وGitHub Actions. |
...
6. **معالجة مقاطعة المستخدم (Ctrl+C & Signals):**
   الضغط على `Ctrl+C` أثناء تفكير الوكيل يرسل حدث `stop` لإيقاف المهمة دون قتل عملية الـ CLI بأكملها. الضغط مرتين متتاليتين ينهي الـ CLI.
