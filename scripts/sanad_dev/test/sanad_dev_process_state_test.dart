...
import 'package:sanad_dev/client_launch_profile.dart' as launch_profile;
import 'package:sanad_dev/runtime_component_control.dart' as component_control;
import 'package:sanad_dev/runtime_context.dart' as runtime_context;
import 'package:sanad_dev/runtime_ownership.dart' as runtime_ownership;
import 'package:sanad_dev/secure_runtime_file.dart' as secure_runtime_file;
import 'package:sanad_dev/startup_attempt.dart' as startup_attempt;
...
void main() {
  ...
  test(
    ...
    () {
      final nestedAgent = sanad_dev.AgentInstance(
        ...
        sanadHome: linkedRuntime.sanadHome,
      );
  ...
  test('Agent-only runtime keeps its discovered Sanad Home', () {
    ...
    expect(sanad_dev.resolveActiveSanadHome(linkedRuntime, state), userHome);
  });
