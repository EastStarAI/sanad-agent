...
import 'package:sanad_dev/runtime_component_control.dart';
...
void main() {
  test('component control request round-trips all selectors', () async {
    ...
    expect(restored?.clientInstanceSlot, '49h-local2');
  ...
  test('all Flutter interactive keys map to explicit Client actions', () {
    ...
    expect(
      runtimeClientInteractiveKeyForAction(RuntimeComponentAction.stop),
      isNull,
    );
  });
