...
import '../../infrastructure/client_launch_profile.dart';
import '../../infrastructure/secure_runtime_file.dart';
  ...
  for (final defines in profiles) {
    ...
    try {
      expectedPreferencesPrefix = sanadDevPreferencesPrefixForClientInstance(
        ...
        defines[sanadDevClientInstanceSlotDefine],
      );
    } on FormatException catch (error) {
      return error.message;
    }
    if (defines['SANAD_SHARED_PREFERENCES_PREFIX'] !=
        expectedPreferencesPrefix) {
